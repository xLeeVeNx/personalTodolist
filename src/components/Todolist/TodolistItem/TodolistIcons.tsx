...
export const DeleteIcon: React.FC<DeleteIconPropsType> = props => {
	const removeTask = () => {
		...
		setTimeout(() => props.removeTask(),900);
	};

	return (
		<Svg onClick={ removeTask } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="20px" height="20px">
...
export const EditIcon: React.FC<EditIconPropsType> = props => {
	const onClickEditHandler = () => props.setEditable(true);

	return (
		<Svg onClick={onClickEditHandler}
			xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="20px" height="20px">
			<linearGradient id="0O0q6J4HBgQKyT39nvTa~a" x1="46.807" x2="46.807" y1="9.849" y2="24.215"
			                gradientUnits="userSpaceOnUse" spreadMethod="reflect">
				<stop offset="0" stopColor="#6dc7ff" />
				<stop offset="1" stopColor="#e6abff" />
			</linearGradient>
			<path className="setting" fill={`${props.fill ? props.fill : 'url(#0O0q6J4HBgQKyT39nvTa~a)'}`}
			...
			<path className="setting" fill={`${props.fill ? props.fill : 'url(#0O0q6J4HBgQKyT39nvTa~b)'}`}
